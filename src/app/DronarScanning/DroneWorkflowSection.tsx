...
export default function LaserWorkflowSection() {
  ...
  const steps = [
    {
      num: "1",
      title: "Planering & Referenspunkter",
      desc: "Utplacering av X/Y/Z-koordinater säkerställer exakt positionering i koordinatsystem.",
      image: "/images/dronar-step1.png",
    },
    {
      num: "2",
      title: "Drönarflygning & Datainsamling",
      desc: "Förprogrammerad rutt, högupplöst kamera, rätt höjd och överlapp.",
      image: "/images/dronar-step2.png",
    },
    {
      num: "3",
      title: "Bearbetning & Leverans",
      desc: "Bilder bearbetas i Agisoft Metashape → Punktmoln, ortofoto, 3D-modell, DWG.",
      image: "/images/dronar-step3.png",
    },
  ];
