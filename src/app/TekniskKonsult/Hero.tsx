    ...
    >
      <div className="relative flex flex-col md:grid md:grid-cols-2 md:h-full max-w-7xl mx-auto items-center">
        ...
        <div className="px-6 md:px-8 lg:px-12 z-10 flex flex-col justify-center items-start h-full">
          ...
          <p className="text-base md:text-lg leading-relaxed md:text-[#A0A0A0] text-gray-600 max-w-md mb-8">
            Vi erbjuder tjänster som teknisk konsult inom byggnads- och geoteknik till kunder såsom
            kommuner, byggföretag, konsulter och privata beställare i hela Skåne.
          </p>
        ...
        <div className="md:hidden w-full aspect-square px-6">
          <div className="relative w-full h-full rounded-t-[12px] overflow-hidden">
            <Image
              src="/images/tekniskkonsulthero.png"
              alt="Teknisk konsult"
              fill
              priority
