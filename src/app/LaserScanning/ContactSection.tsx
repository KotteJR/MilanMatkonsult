  ...
  return (
    <section className="w-full bg-white py-12 md:py-18">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 px-6 md:px-8 lg:px-12 items-start">
        ...
        >
          {[
            { name: 'name', label: "Namn", placeholder: "Skriv in ditt namn", type: 'text', required: true },
            { name: 'email', label: "E-postadress", placeholder: "Skriv in din e-postadress", type: 'email', required: true },
